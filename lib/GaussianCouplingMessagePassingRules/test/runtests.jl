using TestItemRunner, Test, MessagePassingRulesTestUtils, GaussianCouplingMessagePassingRules
...
if !FILTERED_OUT[]
    @testset "rule coverage" begin
        gaps = check_rule_coverage(GaussianCouplingMessagePassingRules)
