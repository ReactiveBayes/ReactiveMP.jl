...
each form of the algorithm declares, and the rules for the `Unscented` method.
...
using MessagePassingRulesApproximations: MessagePassingRulesApproximations, Unscented, unscented_statistics, smoothRTS

export DeltaFn, DeltaApproximation, is_delta_node_compatible

include("node.jl")
include("approximate.jl")
include("rules/unscented.jl")
