using TestItemRunner, Test, MessagePassingRulesTestUtils, DiscreteTransitionMessagePassingRules
...
if !FILTERED_OUT[]
    @testset "rule coverage" begin
        gaps = check_rule_coverage(DiscreteTransitionMessagePassingRules)
