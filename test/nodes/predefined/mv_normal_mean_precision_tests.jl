...
@testitem "MvNormalMeanPrecisionNode" tags = [:nodes] begin
    ...
    @testset "AverageEnergy" begin
        ...
        begin
            ...
            q_μ = MvNormalMeanPrecision(
                ...
                [
                    ...
                    0.5726053202206195 0.515956570765438 0.3402071079911484
                ],
            )
            q_Λ = Wishart(
                4,
                [
                    0.4720138588203935 0.49760446060666863 0.4405032929933653;
                    0.49760446060666863 0.6757755009955487 0.636955076077564;
                    0.4405032929933653 0.636955076077564 0.6660144475917664
                ],
            )
        ...
        begin
            q_out = MvNormalMeanPrecision(
                [0.9580573744420284, 0.26086767384401943, 0.28770712080127914],
                [
                    0.9182022104547379 0.6106281139047683 1.0779505969017997;
                    0.6106281139047683 1.032830918722213 0.9771172696798327;
                    1.0779505969017997 0.9771172696798327 1.5109842607623276
                ],
            )
            q_μ = MvNormalMeanPrecision(
                [0.7234472062526713, 0.2824687847180598, 0.2746840635757333],
                [
                    0.3590359808189558 0.3331759830932437 0.7133660103700628;
                    0.3331759830932437 0.9384711630986695 0.972435803354717;
                    0.7133660103700628 0.972435803354717 1.8219531599263405
                ],
            )
            q_Λ = Wishart(
                4,
                [
                    0.32860287160871043 0.11075216999194112 0.19071629144893898;
                    0.11075216999194112 0.15595676288444096 0.1700073984759777;
                    0.19071629144893898 0.1700073984759777 0.2755688590223264
                ],
            )
        ...
        begin
            q_out = MvNormalMeanPrecision(
                [0.8436742420779029, 0.10538074240979411, 0.6165907670265702],
                [
                    1.9016529880577202 0.10379920228081287 1.8123623785462684;
                    0.10379920228081287 0.608931528715827 0.31789777698874117;
                    1.8123623785462684 0.31789777698874117 1.812858220779861
                ],
            )
            q_μ = MvNormalMeanPrecision(
                [0.2069541691083061, 0.5589468611740172, 0.4820571901630184],
                [
                    0.4530148040808207 0.3039331260702957 0.35941114218805115;
                    0.3039331260702957 0.4389148552241666 0.23999683261779386;
                    0.35941114218805115 0.23999683261779386 0.3727021595284692
                ],
            )
            q_Λ = PointMass(
                [
                    0.705864402777104 1.0323593788454744 0.9684301882026219;
                    1.0323593788454744 1.7349617392942005 1.7059080462235048;
                    0.9684301882026219 1.7059080462235048 1.816579920226959
                ],
            )
