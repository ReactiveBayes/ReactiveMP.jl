...
@testset "MvNormalMeanPrecisionNode" begin
    ...
    @testset "AverageEnergy" begin 
        ...
        begin 
            ...
            for N1 in (MvNormalMeanPrecision, MvNormalMeanCovariance, MvNormalWeightedMeanPrecision), N2 in (MvNormalMeanPrecision, MvNormalMeanCovariance, MvNormalWeightedMeanPrecision), G in (Wishart, )
                marginals = (Marginal(convert(N1, q_out), false, false), Marginal(convert(N2, q_μ), false, false), Marginal(convert(G, q_Λ), false, false))
        ...
        begin 
            ...
            for N1 in (MvNormalMeanPrecision, MvNormalMeanCovariance, MvNormalWeightedMeanPrecision), N2 in (MvNormalMeanPrecision, MvNormalMeanCovariance, MvNormalWeightedMeanPrecision)
                marginals = (Marginal(convert(N1, q_out), false, false), Marginal(convert(N2, q_μ), false, false), Marginal(q_Λ, false, false))
                @test score(AverageEnergy(), MvNormalMeanPrecision, Val{(:out, :μ, :Λ)}, marginals, nothing) ≈ 38.31309509463591
            end
        end

        begin 
            q_out_μ = MvNormalMeanPrecision([0.2932046487282065, 0.7716085147100042, 0.03978072440454361, 0.2814883836121471], [1.0684808331872628 0.6721958601342372 0.7164104160110533 0.2869444930570181; 0.6721958601342372 1.4472786772965438 1.3516272546828385 0.5533932426057602; 0.7164104160110533 1.3516272546828385 1.2958919150214063 0.5171784879755998; 0.2869444930570181 0.5533932426057602 0.5171784879755998 0.30898006058959576])
        ...
        begin 
            q_out_μ = MvNormalMeanPrecision([0.35156676223859784, 0.6798203100143094, 0.954485919235333, 0.9236981452828203], [1.3182839156957349 0.9159049032047119 1.170482409249098 1.132202025059748; 0.9159049032047119 1.4737964254194567 1.4024254322343757 0.7350293025705011; 1.170482409249098 1.4024254322343757 2.0577570913647105 1.3137472032115916; 1.132202025059748 0.7350293025705011 1.3137472032115916 1.2083880803032556])
        ...
        begin 
            q_out_μ = MvNormalMeanPrecision([0.5500318675144917, 0.817183383468487, 0.5347013723720735, 0.5114047207869656], [1.1343108996797893 0.47265813998866796 0.9272779005094741 1.0428711245585718; 0.47265813998866796 0.715974520938224 0.7635970006454071 1.193450872579602; 0.9272779005094741 0.7635970006454071 1.392689362184066 1.5818118006093156; 1.0428711245585718 1.193450872579602 1.5818118006093156 2.158417891827849])
