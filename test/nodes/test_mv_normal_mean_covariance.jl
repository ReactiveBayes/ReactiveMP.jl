...
@testset "MvNormalMeanCovarianceNode" begin
    ...
    @testset "Creation" begin
        ...
        node = make_node(MvNormalMeanCovariance, meta = 1)
        ...
        node = make_node(MvNormalMeanCovariance, factorisation = ((1, ), (2, 3)))
    ...
    @testset "AverageEnergy" begin 
        ...
        begin 
            ...
            for N in (MvNormalMeanPrecision, MvNormalMeanCovariance, MvNormalWeightedMeanPrecision)
                marginals = (Marginal(q_out, false, false), Marginal(convert(N, q_μ), false, false), Marginal(q_Σ, false, false))
        ...
        begin 
            ...
            for N1 in (MvNormalMeanPrecision, MvNormalMeanCovariance, MvNormalWeightedMeanPrecision), N2 in (MvNormalMeanPrecision, MvNormalMeanCovariance, MvNormalWeightedMeanPrecision)
                marginals = (Marginal(convert(N1, q_out), false, false), Marginal(convert(N2, q_μ), false, false), Marginal(q_Σ, false, false))
        ...
        begin 
            q_out_μ = MvNormalMeanCovariance([0.7110546689402384, 0.2550803989358359, 0.7284714504680616, 0.4523569391382931], [0.9354883429919909 0.979541773915805 0.11235208550731414 0.720928227797172; 0.979541773915805 1.5518339076149474 0.27953313117565737 0.9410472233142694; 0.11235208550731414 0.27953313117565737 0.09215639567249542 0.15210811270662963; 0.720928227797172 0.9410472233142694 0.15210811270662963 0.7114840285830272])
        ...
        begin 
            q_out_μ = MvNormalMeanCovariance([0.6273836373763129, 0.2611455272882084, 0.15015693447418932, 0.7907870618820343], [2.4624395254748563 1.3049173253859347 2.2581875619221057 1.8418052081652991; 1.3049173253859347 1.0230726719658598 1.0344117375112738 0.8684398658701927; 2.2581875619221057 1.0344117375112738 2.164616392026885 1.7042534061619456; 1.8418052081652991 0.8684398658701927 1.7042534061619456 1.5840784999702135])
