...
@testitem "rules:MvNormalMeanCovariance:covariance" tags = [:rules] begin
    ...
    @testset "Variational: (q_out::PointMass, q_μ::MultivariateNormalDistributionsFamily)" begin
        @test_rules [check_type_promotion = true] MvNormalMeanCovariance(
            ...
            (
                ...
                output = InverseWishartFast(-2.0, [7.0 8.0; 8.0 13.0]),
            ),
            (
                input = (
            ...
            (
                ...
                output = InverseWishartFast(
                    -3.0, [10.0 6.0 -10.0; 6.0 13.0 -15.0; -10.0 -15.0 33.0]
                ),
            ),
        ]
        @test_rules [check_type_promotion = true] MvNormalMeanCovariance(
    ...
    @testset "Variational: (q_out_μ::MultivariateNormalDistributionsFamily)" begin
        @test_rules [check_type_promotion = true] MvNormalMeanCovariance(
            ...
            (
                ...
                output = InverseWishartFast(-2.0, [2.0 0.0; 0.0 2.0]),
            ),
            (
