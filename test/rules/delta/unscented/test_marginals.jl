module RulesDeltaMarginalsTest
    ...
    @testset "Marginal: f(x) (m_ins::NormalMeanCovariance, meta.inverse::Nothing)" begin
        ...
        @test_marginalrules [with_float_conversions = false] DeltaFn{h}(:ins) [
            (
                ...
                output = MvNormalMeanCovariance([2.3636363470614055, 4.9090909132334355], [0.2727273058237252 0.1818181735464949; 0.18181817354649488 0.9545454566127697])
            )
        ]
    end
end # testset
