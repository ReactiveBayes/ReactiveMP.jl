    ...
    @testset "Variational: (q_out_μ::MultivariateNormalDistributionsFamily, q_G::Wishart)" begin
        ...
        @test_rules [check_type_promotion = true] MvNormalMeanScaleMatrixPrecision(
            ...
            (
                ...
                output = GammaShapeRate(2.0, 132.0),
            ),
            (
                input = (
                    q_out_μ = MvNormalMeanPrecision(ones(4), diageye(4)),
                    q_G = Wishart(4, [13.0 14.0; 14.0 20.0]),
                ),
                output = GammaShapeRate(2.0, 132.0),
            ),
        ...
        @test_rules [check_type_promotion = true] MvNormalMeanScaleMatrixPrecision(
            ...
            (
                input = (
                    q_out_μ = MvNormalMeanCovariance(a, A),
                    q_G = Wishart(4, [13.0 14.0; 14.0 20.0]),
                ),
                output = GammaShapeRate(2, 1852.0),
            ),
            (
                input = (
                    q_out_μ = MvNormalMeanPrecision(a, A),
                    q_G = Wishart(4, [13.0 14.0; 14.0 20.0]),
                ),
                output = GammaShapeRate(2, 1224.3440167026847),
            ),
            (
                input = (
                    q_out_μ = MvNormalWeightedMeanPrecision(a, A),
                ...
                output = GammaShapeRate(2, 106.333391526103),
            ),
        ]
    end
end
