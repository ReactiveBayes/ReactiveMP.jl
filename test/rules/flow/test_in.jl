...
@testset "rules:Flow:in" begin
    ...
    @testset "Belief Propagation: (m_out::MvNormalMeanCovariance, )" begin
    ...
    @testset "Belief Propagation: (m_out::MvNormalMeanPrecision, )" begin
    ...
    @testset "Belief Propagation: (m_out::MvNormalWeightedMeanPrecision, )" begin
