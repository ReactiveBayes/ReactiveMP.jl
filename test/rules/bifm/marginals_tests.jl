...
@testitem "marginalrules:BIFM" begin
    ...
    @testset ":in_zprev_znext (m_out::MultivariateNormalDistributionsFamily, m_in::MultivariateNormalDistributionsFamily, m_zprev::TerminalProdArgument{<:MultivariateNormalDistributionsFamily}, m_znext::MultivariateNormalDistributionsFamily)" begin
        ...
        @test_marginalrules [check_type_promotion = true, atol = [Float32 => 1e-2, Float64 => 1e-2, BigFloat => 1e-8]] BIFM(:in_zprev_znext) [
            (
                input  = (m_out = MvNormalMeanPrecision([1, 2], [2 0; 0 1]), m_in = MvNormalMeanPrecision([1, 2], [1 0; 0 2]), m_zprev = TerminalProdArgument(MvNormalMeanPrecision([1, 2], [1 0; 0 2])), m_znext = MvNormalMeanPrecision([1, 2], [1 0; 0 3]), meta = meta),
            ...
            (
                input  = (m_out = MvNormalMeanPrecision([3, 4], [6 0; 0 1]), m_in = MvNormalMeanPrecision([8, 2], [2 0; 0 2]), m_zprev = TerminalProdArgument(MvNormalMeanPrecision([1, 6], [2 0; 0 2])), m_znext = MvNormalMeanPrecision([1, 2], [1 0; 0 3]), meta = meta),
            ...
            (
                input  = (m_out = MvNormalMeanPrecision([5, 6], [2 0; 0 5]), m_in = MvNormalMeanPrecision([1, 9], [1 0; 0 1]), m_zprev = TerminalProdArgument(MvNormalMeanPrecision([6, 2], [1 0; 0 1])), m_znext = MvNormalMeanPrecision([1, 2], [1 0; 0 3]), meta = meta),
