...
@testitem "rules:BIFM:in" tags = [:rules] begin
    ...
    @testset "Belief Propagation: (m_out::MultivariateNormalDistributionsFamily, m_zprev::TerminalProdArgument{<:MultivariateNormalDistributionsFamily}, m_znext::MultivariateNormalDistributionsFamily, meta::BIFMMeta)" begin
        ...
        ] BIFM(:in, Marginalisation) [
            (
                input = (
                    m_out = MvNormalMeanPrecision([1, 2], [2 0; 0 1]),
                    m_zprev = TerminalProdArgument(
                        MvNormalMeanPrecision([1, 2], [1 0; 0 2])
                    ),
                ...
                output = TerminalProdArgument(
                    MvNormalMeanCovariance(
                        [-375, -172], [180801 0.0; 0.0 4487.999999999998]
                    ),
                ),
            ),
            (
                input = (
                    ...
                    m_zprev = TerminalProdArgument(
                        MvNormalMeanPrecision([1, 6], [2 0; 0 2])
                    ),
                ...
                output = TerminalProdArgument(
                    MvNormalMeanCovariance(
                        [-375, -620],
                        [87488.99999999997 0.0; 0.0 4487.999999999998],
                    ),
                ),
            ),
            (
                input = (
                    ...
                    m_zprev = TerminalProdArgument(
                        MvNormalMeanPrecision([6, 2], [1 0; 0 1])
                    ),
                ...
                output = TerminalProdArgument(
                    MvNormalMeanCovariance(
                        [-2535, -172], [180801 0.0; 0.0 10760.0]
                    ),
                ),
            ),
        ]
