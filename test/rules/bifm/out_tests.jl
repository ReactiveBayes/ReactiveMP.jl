...
@testitem "rules:BIFM:out" tags = [:rules] begin
            ...
            (
                ...
                output = TerminalProdArgument(
                    MvNormalMeanCovariance(
                        [-280, -126], [107680.0 0.0; 0.0 3829.4999999999986]
                    ),
                ),
            ),
            (
                ...
                output = TerminalProdArgument(
                    MvNormalMeanCovariance(
                        [-280, -462],
                        [53887.99999999999 0.0; 0.0 3829.4999999999986],
                    ),
                ),
            ),
            (
                ...
                output = TerminalProdArgument(
                    MvNormalMeanCovariance(
                        [-1872, -130.8], [107680.0 0.0; 0.0 7614.0]
                    ),
                ),
            ),
        ]
