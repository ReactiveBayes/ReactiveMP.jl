...
@testitem "rules:Probit:in" begin
    ...
    @testset "Expectation Propagation: (m_out::Bernoulli, m_in::UnivariateNormalDistributionsFamily)" begin
        ...
        @test_rules [check_type_promotion = false, atol = 1e-13] Probit(:in, Marginalisation) [
        ...
        @test_rules [check_type_promotion = false, atol = 1e-7] Probit(:in, Marginalisation) [
        ...
        @test_rules [check_type_promotion = false, atol = 1e-25] Probit(:in, Marginalisation) [
