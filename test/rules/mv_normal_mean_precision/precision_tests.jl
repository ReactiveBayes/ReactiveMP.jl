...
@testitem "rules:MvNormalMeanPrecision:precision" begin
    ...
    @testset "Variational: (q_out::PointMass, q_μ::MultivariateNormalDistributionsFamily)" begin
        @test_rules [check_type_promotion = true] MvNormalMeanPrecision(
            ...
            (
                ...
                output = WishartFast(
                    4.0, cholinv([75/73 -46/73; -46/73 36/73])
                )
            ),
            (
                input = (
            ...
            (
                ...
                output = WishartFast(
                    4.0, cholinv([39/74 -11/37; -11/37 10/37])
                )
            ),
            (
                input = (
                    q_out = MvNormalMeanPrecision(
                        [1.0; 2.0; 3.0], [3.0 0.0 0.0; 0.0 2.0 0.0; 0.0 0.0 4.0]
                    ),
                ...
                output = WishartFast(
                    5.0,
                    cholinv(
                        [15/11 -3/22 5/11; -3/22 19/22 5/11; 5/11 5/11 16/33]
                    )
                )
            )
        ]
        ...
        @test_rules [check_type_promotion = true] MvNormalMeanPrecision(
            ...
            (
                ...
                output = WishartFast(
                    4.0, cholinv([73/67 -26/67; -26/67 68/67])
                )
            ),
            (
                input = (
                ...
                output = WishartFast(
                    4.0, cholinv([165/163 -106/163; -106/163 76/163])
                )
            ),
            (
                input = (
            ...
            (
                ...
                output = WishartFast(
                    ...
                    cholinv(
                        [
                            459/338 -36/169 60/169;
                            -36/169 115/169 90/169;
                            60/169 90/169 188/169
                        ]
                    )
                )
            )
    ...
    @testset "Variational: (q_out_μ::MultivariateNormalDistributionsFamily)" begin
        @test_rules [check_type_promotion = true] MvNormalMeanPrecision(
            ...
            (
                input = (
                    q_out_μ = MvNormalMeanCovariance(ones(4), diageye(4)),
                ),
                output = WishartFast(4.0, cholinv([0.5 0.0; 0.0 0.5]))
            ),
            (
        ...
        @test_rules [check_type_promotion = true] MvNormalMeanPrecision(
            ...
            (
                ...
                output = WishartFast(4.0, cholinv([13/150 -2/75; -2/75 7/150]))
            ),
            (
                input = (q_out_μ = MvNormalMeanPrecision(a, A),),
                output = WishartFast(
                    4.0, cholinv([3751/1966 -3653/3932; -3653/3932 30259/58980])
                )
            ),
            (
                ...
                output = WishartFast(
                    ...
                    cholinv(
                        [
                            139109613/68523766 -96827813/137047532;
                            -96827813/137047532 62742851/68523766
                        ]
                    )
                )
            )
