...
@testitem "rules:Transition:out" begin
    ...
    @testset "Belief Propagation: (m_in::Categorical, q_a::TensorDirichlet, m_t1::Categorical)" begin
        @test_rules [check_type_promotion = false] Transition(:out, Marginalisation) [
            (
                input = (
                    m_in = Categorical([0.08799332630703943, 0.29132551818215013, 0.6206811555108104]),
                    q_a = TensorDirichlet([10.0 2.0 9.0; 1.0 6.0 1.0; 10.0 7.0 10.0;;; 2.0 4.0 8.0; 2.0 3.0 7.0; 5.0 3.0 8.0;;; 1.0 7.0 8.0; 2.0 10.0 10.0; 8.0 9.0 3.0]),
            ...
            (
                input = (
                    ...
                    q_a = TensorDirichlet([9.0 6.0 8.0; 8.0 9.0 2.0; 2.0 5.0 8.0;;; 3.0 10.0 6.0; 4.0 6.0 1.0; 7.0 8.0 3.0;;; 8.0 8.0 7.0; 1.0 8.0 4.0; 6.0 4.0 2.0]),
            ...
            (
                input = (
                    ...
                    q_a = TensorDirichlet([5.0 1.0 10.0; 9.0 5.0 4.0; 7.0 2.0 6.0;;; 9.0 7.0 5.0; 4.0 3.0 3.0; 2.0 4.0 8.0;;; 8.0 9.0 9.0; 6.0 10.0 10.0; 8.0 9.0 6.0]),
            ...
            (
                input = (
                    ...
                    q_a = TensorDirichlet([6.0 9.0 8.0; 9.0 9.0 4.0; 1.0 6.0 8.0;;; 3.0 6.0 8.0; 3.0 8.0 5.0; 4.0 5.0 2.0;;; 10.0 1.0 8.0; 2.0 7.0 1.0; 7.0 7.0 3.0]),
            ...
            (
                input = (
                    ...
                    q_a = TensorDirichlet([10.0 5.0 1.0; 10.0 8.0 4.0; 10.0 4.0 1.0;;; 9.0 9.0 4.0; 1.0 10.0 3.0; 7.0 4.0 1.0;;; 4.0 8.0 6.0; 4.0 9.0 4.0; 3.0 9.0 5.0]),
    ...
    @testset "Belief Propagation: (m_in::Categorical, q_a::TensorDirichlet, m_t1::Categorical, m_t2::Categorical)" begin
        @test_rules [check_type_promotion = false] Transition(:out, Marginalisation) [
            (
                input = (
                    m_in = Categorical([0.08799332630703943, 0.29132551818215013, 0.6206811555108104]),
