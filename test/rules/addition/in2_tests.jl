...
@testitem "rules:typeof(+):in2" tags = [:rules] begin
    ...
    @testset "Belief Propagation: (m_out::PointMass, m_in1::PointMass)" begin
        @test_rules [check_type_promotion = true] typeof(+)(
            ...
            (
                input = (m_out = PointMass(1.0), m_in1 = PointMass(-1.0)),
                output = PointMass(2.0),
            ),
            (
                input = (m_out = PointMass([1.0]), m_in1 = PointMass([-2.0])),
                output = PointMass([3.0]),
            ),
            (
                input = (
                    m_out = PointMass([1.0 2.0; 3.0 4.0]),
                    m_in1 = PointMass([-2.0 -1.0; -4.0 -1.0]),
                ),
    ...
    @testset "Belief Propagation: (m_out::UnivariateNormalDistributionsFamily, m_in1::UnivariateNormalDistributionsFamily)" begin
        @test_rules [check_type_promotion = true] typeof(+)(
            ...
            (
                input = (
                    m_out = NormalMeanVariance(-1.0, 2.0),
                    m_in1 = NormalMeanVariance(-2.0, 3.0),
                ),
            ...
            (
                input = (
                    ...
                    m_in1 = NormalMeanPrecision(-1.0, 3.0),
                ),
            ...
            (
                input = (
                    m_out = NormalWeightedMeanPrecision(8.0, 4.0),
                    m_in1 = NormalMeanVariance(-3.0, 1.0),
                ),
            ...
            (
                input = (
                    ...
                    m_in1 = NormalWeightedMeanPrecision(6.0, 3.0),
                ),
