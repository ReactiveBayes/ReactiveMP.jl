...
@testitem "rules:NormalMeanPrecision:mean" tags = [:rules] begin
    ...
    @testset "Belief Propagation: (m_out::PointMass, m_τ::PointMass)" begin
        @test_rules [check_type_promotion = true] NormalMeanPrecision(
            ...
            (
                input = (m_out = PointMass(-1.0), m_τ = PointMass(2.0)),
            ...
            (
                input = (m_out = PointMass(2.0), m_τ = PointMass(1.0)),
    ...
    @testset "Variational: (m_out::UnivariateNormalDistributionsFamily, q_τ::Any)" begin
        @test_rules [check_type_promotion = true] NormalMeanPrecision(
            ...
            (
                input = (
                    m_out = NormalMeanPrecision(0.0, 1.0),
            ...
            (
                input = (
                    m_out = NormalMeanPrecision(2.0, 0.5),
        ...
        @test_rules [check_type_promotion = true] NormalMeanPrecision(
            ...
            (
                input = (
                    m_out = NormalMeanVariance(2.0, 0.5),
                    q_τ = GammaShapeScale(10.0, 0.1),
                ),
                output = NormalMeanVariance(2.0, 3.0 / 2.0),
            ),
    ...
    @testset "Variational: (m_out::PointMass, q_τ::Any)" begin
        @test_rules [check_type_promotion = true] NormalMeanPrecision(
            ...
            (
                input = (m_out = PointMass(2.0), q_τ = PointMass(1.0)),
                output = NormalMeanPrecision(2.0, 1.0),
            ),
        ]
    end
    ...
    @testset "Variational: (q_out::Any, q_τ::Any)" begin
        @test_rules [check_type_promotion = true] NormalMeanPrecision(
            ...
            (
                input = (q_out = PointMass(-1.0), q_τ = PointMass(2.0)),
                output = NormalMeanPrecision(-1.0, 2.0),
            ),
            (
                input = (q_out = PointMass(1.0), q_τ = PointMass(2.0)),
            ...
            (
                input = (q_out = PointMass(2.0), q_τ = PointMass(1.0)),
                output = NormalMeanPrecision(2.0, 1.0),
            ),
        ]
        ...
        @test_rules [check_type_promotion = true] NormalMeanPrecision(
            ...
            (
                input = (q_out = PointMass(-1.0), q_τ = Gamma(2.0, 1.0)),
                output = NormalMeanPrecision(-1.0, 2.0),
            ),
            (
                input = (q_out = PointMass(1.0), q_τ = Gamma(4.0, 2.0)),
                output = NormalMeanPrecision(1.0, 8.0),
            ),
            (
                input = (q_out = PointMass(2.0), q_τ = Gamma(4.0, 6.0)),
