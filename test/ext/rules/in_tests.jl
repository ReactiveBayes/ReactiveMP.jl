@testitem "Basic check for in rule" begin
    ...
    # q_ins_approximated = prod(GenericProd(), m_in_outbound_approximated, m_in_incoming)
    # left_q_ins_approximated = BayesBase.getleft(q_ins_approximated)
    # right_q_ins_approximated = BayesBase.getright(q_ins_approximated)
