...
@testset "Dirichlet" begin
    ...
    @testset "prod" begin
        @test prod(ProdPreserveParametrisation(), Dirichlet([ 1.0, 1.0, 1.0 ]), Dirichlet([ 1.0, 1.0, 1.0 ])) == Dirichlet([ 1.0, 1.0, 1.0 ])
        @test prod(ProdPreserveParametrisation(), Dirichlet([ 1.1, 1.0, 2.0 ]), Dirichlet([ 1.0, 1.2, 1.0 ])) == Dirichlet([1.1, 1.2000000000000002, 2.0])
        @test prod(ProdPreserveParametrisation(), Dirichlet([ 1.1, 2.0, 2.0 ]), Dirichlet([ 3.0, 1.2, 5.0 ])) == Dirichlet([3.0999999999999996, 2.2, 6.0])
        
        @test prod(ProdBestSuitableParametrisation(), Dirichlet([ 1.0, 1.0, 1.0 ]), Dirichlet([ 1.0, 1.0, 1.0 ])) == Dirichlet([ 1.0, 1.0, 1.0 ])
        @test prod(ProdBestSuitableParametrisation(), Dirichlet([ 1.1, 1.0, 2.0 ]), Dirichlet([ 1.0, 1.2, 1.0 ])) == Dirichlet([1.1, 1.2000000000000002, 2.0])
        @test prod(ProdBestSuitableParametrisation(), Dirichlet([ 1.1, 2.0, 2.0 ]), Dirichlet([ 3.0, 1.2, 5.0 ])) == Dirichlet([3.0999999999999996, 2.2, 6.0])
    end
