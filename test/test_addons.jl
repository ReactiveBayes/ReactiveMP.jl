...
@testset "Addons" begin
    @testset "addonlogscale" begin
        ...
        @testset "multiply_addons" begin
            ...
            @test multiply_addons(left_addons, right_addons, new_dist, left_dist, right_dist) ==
                  (AddonLogScale(11.0 - log(2)),)
            @test multiply_addons(AddonLogScale(5), AddonLogScale(6.0), new_dist, left_dist, right_dist) ==
                  AddonLogScale(11.0 - log(2))
