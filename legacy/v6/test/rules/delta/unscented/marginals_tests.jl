...
@testitem "rules:Delta:unscented:marginals" tags = [:rules] begin
    ...
    @testset "Single univariate input" begin
        @test_marginalrules [check_type_promotion = false, atol = 1.0e-10] DeltaFn{
            g,
        }(
            :ins
        ) [
            (
                ...
                output = JointNormal(
                    NormalMeanVariance(2.3809523807887425, 0.23809523822182999),
                    ((),),
                ),
            ),
        ]
            ...
            (
                ...
                output = JointNormal(
                    MvNormalMeanCovariance(
                        [2.3809523807887425], [0.23809523822182999;;]
                    ),
                    ((1,),),
                ),
            ),
    ...
    @testset "Multiple univairate input" begin
        ...
        @test_marginalrules [check_type_promotion = false, atol = 1.0e-4] DeltaFn{
            h,
        }(
            :ins
        ) [
            (
                ...
                output = JointNormal(
                    MvNormalMeanCovariance(
                        ...
                        [
                            0.2727273058237252 0.1818181735464949;
                            0.18181817354649488 0.9545454566127697
                        ],
                    ),
                    ((), ()),
                ),
            ...
            (
                ...
                output = JointNormal(
                    MvNormalMeanCovariance(
                        ...
                        [
                            0.2727273058246874 0.18181817354625435;
                            0.18181817354625435 0.9545454566128299
                        ],
                    ),
                    ((1,), (1,)), # [1, 1]
                ),
