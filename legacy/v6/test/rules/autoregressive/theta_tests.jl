...
@testitem "rules:Autoregressive:θ" tags = [:rules] begin
    ...
    @testset "Mean-field: (q_x::Any, q_y::Any, q_γ::Any)" begin
        ...
        @test_rules [check_type_promotion = true] Autoregressive(
            :θ, Marginalisation
        ) [
            (
                input = (
                    q_y = NormalMeanVariance(1.0, 1.0),
                    q_x = NormalMeanVariance(1.0, 1.0),
            ...
            (
                input = (
                    q_y = NormalWeightedMeanPrecision(1.0, 1.0),
                    q_x = NormalMeanPrecision(1.0, 2.0),
