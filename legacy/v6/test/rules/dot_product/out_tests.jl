...
@testitem "rules:typeof(dot):out" tags = [:rules] begin
    ...
    @testset "Belief Propagation: (m_in1::PointMass, m_in2::NormalDistributionsFamily)" begin
        @test_rules [check_type_promotion = true] typeof(dot)(
            ...
            (
                input = (
                    m_in1 = PointMass(-1.0),
                    m_in2 = NormalMeanPrecision(3.0, 1.0),
                    meta = NoCorrection(),
                ),
    ...
    @testset "Belief Propagation: (m_in1::NormalDistributionsFamily, m_in2::PointMass)" begin
        @test_rules [check_type_promotion = true] typeof(dot)(
            ...
            (
                input = (
                    m_in1 = NormalMeanPrecision(2.0, inv(3.0)),
                    m_in2 = PointMass(2.0),
                    meta = NoCorrection(),
                ),
