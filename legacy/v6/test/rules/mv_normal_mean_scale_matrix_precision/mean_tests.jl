...
@testitem "rules:MvNormalMeanScaleMatrixPrecision:mean" tags = [:rules] begin
    ...
    @testset "Variational: (q_out::MultivariateNormalDistributionsFamily, q_γ::Gamma, q_G::Wishart)" begin
        ...
        @test_rules [check_type_promotion = true] MvNormalMeanScaleMatrixPrecision(
            ...
            (
                ...
                output = MvNormalMeanPrecision(
                    [2.0, 3.0], [156.0 168.0; 168.0 240.0]
                ),
            ),
        ]
    end
        ...
        @test_rules [check_type_promotion = true] MvNormalMeanScaleMatrixPrecision(
            ...
            (
                ...
                output = MvNormalMeanPrecision(
                    [2.0, 1.0],
                    [
                        2.777070063694267 1.9872611464968155;
                        1.9872611464968155 3.770700636942675
                    ],
                ),
            ),
            (
                ...
                output = MvNormalMeanPrecision(
                    [0.0, 0.0],
                    [
                        0.1444643743381126 0.016444116187372262;
                        0.016444116187372262 0.1126703322039727
                    ],
                ),
            ),
            (
                ...
                output = MvNormalMeanPrecision(
                    ...
                    [
                        2.8822495606326877 1.9964850615114234;
                        1.9964850615114234 3.8804920913884007
                    ],
                ),
            ),
        ]
