...
@testitem "rules:NormalMixture:out" tags = [:rules] begin
        ...
        @test_rules [check_type_promotion = true] NormalMixture{2}(
            ...
            (
                input = (
                    ...
                    q_p = ManyOf(
                        GammaShapeRate(1.0, 2.0), GammaShapeRate(2.0, 1.0)
                    ),
                ),
            ...
            (
                input = (
                    ...
                    q_p = ManyOf(
                        GammaShapeRate(1.0, 1.0), GammaShapeScale(2.0, 0.1)
                    ),
                ),
            ...
            (
                input = (
                    ...
                    q_m = ManyOf(
                        NormalWeightedMeanPrecision(-1.0, 2.0),
                        NormalMeanPrecision(2.0, 3.0),
                    ),
                    q_p = ManyOf(
                        GammaShapeScale(1.0, 1.0), GammaShapeRate(2.0, 0.1)
                    ),
                ),
        ...
        @test_rules [check_type_promotion = true] NormalMixture{2}(
            ...
            (
                input = (
                    q_switch = Categorical([0.5, 0.5]),
                    q_m = ManyOf(
                        PointMass([1.0, 0.0]), PointMass([-1.0, -2.0])
                    ),
                    q_p = ManyOf(
                        PointMass(2.0 * diageye(2)), PointMass(3.0 * diageye(2))
                    ),
                ),
        ...
        @test_rules [check_type_promotion = true] NormalMixture{2}(
            ...
            (
                input = (
                    ...
                    q_p = ManyOf(
                        Wishart(3.0, [2.0 -0.25; -0.25 1.0]),
                        Wishart(3.0, [1.0 -0.25; -0.25 2.0]),
                    ),
                ),
                output = MvNormalWeightedMeanPrecision(
