...
@testitem "NormalMeanPrecisionNode" tags = [:nodes] begin
    ...
    @testset "AverageEnergy" begin
        ...
        begin
            q_out = PointMass(1.0)
            q_μ_τ = (
                μ = NormalMeanPrecision(1.0, 1.0), τ = GammaShapeRate(1.5, 1.5),
            )
        ...
        begin
            ...
            q_μ = NormalMeanPrecision(0.255332, 0.76287)
        ...
        begin
            ...
            @test_throws r"\(q_a::.*PointMass.*, q_b::.*PointMass.*, q_c::.*PointMass.*, \)" score(
                AverageEnergy(),
                NormalMeanPrecision,
                Val{(:a, :b, :c)}(),
                marginals,
