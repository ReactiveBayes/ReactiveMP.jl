...
paramfloattype(distribution::Contingency) = deep_eltype(contingency_matrix(distribution))

convert_paramfloattype(::Type{T}, distribution::Contingency) where {T <: Real} = Contingency(convert_paramfloattype(T, contingency_matrix(distribution)))
