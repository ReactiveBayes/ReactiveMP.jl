...
@rule typeof(*)(:A, Marginalisation) (m_out::PointMass, m_in::PointMass, meta::Union{<:AbstractCorrectionStrategy, Nothing}) = PointMass(
    mean(m_in) \ mean(m_out)
)
...
@rule typeof(*)(:A, Marginalisation) (
    ...
    return convert(
        promote_variate_type(F, NormalWeightedMeanPrecision), A * ξ_out, W
    )
end
