...
# Belief Propagation                #
# --------------------------------- #
@rule NormalMeanPrecision(:μ, Marginalisation) (m_out::PointMass, m_τ::PointMass) = begin
    @logscale 0
...
# Variational                       # 
# --------------------------------- #
@rule NormalMeanPrecision(:μ, Marginalisation) (q_out::PointMass, q_τ::PointMass) = begin
    @logscale 0
    NormalMeanPrecision(mean(q_out), mean(q_τ))
end
