...
@marginalrule NormalMeanPrecision(:out_μ_τ) (m_out::NormalMeanPrecision, m_μ::Dirac, m_τ::Dirac) = begin
    return (out = prod(ProdPreserveParametrisation(), NormalMeanPrecision(mean(m_μ), mean(m_τ)), m_out), μ = m_μ, τ = m_τ)
end

@marginalrule NormalMeanPrecision(:out_μ_τ) (m_out::Dirac, m_μ::NormalMeanPrecision, m_τ::Dirac) = begin
