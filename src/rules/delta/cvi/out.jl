...
@rule DeltaFn{f}(:out, Marginalisation) (q_ins::FactorizedJoint{P}, meta::CVIApproximation) where {f, P <: NTuple{1}} = begin
...
@rule DeltaFn{f}(:out, Marginalisation) (q_ins::FactorizedJoint, meta::CVIApproximation) where {f} = begin
