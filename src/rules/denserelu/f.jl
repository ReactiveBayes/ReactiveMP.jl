...
# @rule DenseReLU((:f, k), Marginalisation) (q_output::MultivariateNormalDistributionsFamily, q_input::UnivariateNormalDistributionsFamily, q_w::UnivariateNormalDistributionsFamily, q_z::Bernoulli, meta::DenseReLUMeta) = begin
