...
# PointMass
@rule typeof(+)(:out, Marginalisation) (m_in1::PointMass, m_in2::PointMass) = PointMass(
    mean(m_in1) + mean(m_in2)
)
...
# specialized
@rule typeof(+)(:out, Marginalisation) (
    m_in1::MvNormalWeightedMeanPrecision{T, Vector{T}, Matrix{T}},
...
@rule typeof(+)(:out, Marginalisation) (
    m_in1::MvNormalWeightedMeanPrecision{T1, Vector{T1}, Matrix{T1}},
    m_in2::PointMass
) where {T1} = begin
