...
# PointMass
@rule typeof(+)(:in1, Marginalisation) (m_out::PointMass, m_in2::PointMass) = PointMass(
    mean(m_out) - mean(m_in2)
)

@rule typeof(+)(:in1, Marginalisation) (
    m_out::PointMass, m_in2::NormalMeanPrecision
) = begin
...
@rule typeof(+)(:in1, Marginalisation) (
    m_out::NormalMeanPrecision, m_in2::PointMass
) = begin
...
@rule typeof(+)(:in1, Marginalisation) (
    m_out::PointMass, m_in2::MvNormalMeanPrecision
) = begin
    min2, win2 = mean_precision(m_in2)
...
@rule typeof(+)(:in1, Marginalisation) (
    m_out::MvNormalMeanPrecision, m_in2::PointMass
) = begin
    mout, wout = mean_precision(m_out)
...
@rule typeof(+)(:in1, Marginalisation) (
    m_out::PointMass, m_in2::UnivariateNormalDistributionsFamily
) = begin
    min2, vin2 = mean_var(m_in2)
...
@rule typeof(+)(:in1, Marginalisation) (
    m_out::UnivariateNormalDistributionsFamily, m_in2::PointMass
) = begin
    mout, vout = mean_var(m_out)
...
@rule typeof(+)(:in1, Marginalisation) (
    m_out::PointMass, m_in2::MultivariateNormalDistributionsFamily
) = begin
    min2, vin2 = mean_cov(m_in2)
...
@rule typeof(+)(:in1, Marginalisation) (
    m_out::MultivariateNormalDistributionsFamily, m_in2::PointMass
) = begin
    mout, vout = mean_cov(m_out)
...
# specialized
@rule typeof(+)(:in1, Marginalisation) (
    m_out::MvNormalWeightedMeanPrecision{T, Vector{T}, Matrix{T}},
    m_in2::MvNormalWeightedMeanPrecision{T, Vector{T}, Matrix{T}},
...
@rule typeof(+)(:in1, Marginalisation) (
    m_out::MvNormalWeightedMeanPrecision{T1, Vector{T1}, Matrix{T1}},
    m_in2::PointMass,
) where {T1} = begin
...
@rule typeof(+)(:in1, Marginalisation) (
    m_out::PointMass,
    m_in2::MvNormalWeightedMeanPrecision{T1, Vector{T1}, Matrix{T1}},
) where {T1} = begin
