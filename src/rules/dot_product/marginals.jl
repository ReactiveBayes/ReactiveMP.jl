...
@marginalrule typeof(dot)(:in1_in2) (
...
@marginalrule typeof(dot)(:in1_in2) (
    ...
    symmetric = @call_marginalrule typeof(dot)(:in1_in2) (
        m_out = m_out, m_in1 = m_in2, m_in2 = m_in1, meta = meta
    )
    return convert_paramfloattype((
        in1 = symmetric[:in2], in2 = symmetric[:in1]
    ))
end
