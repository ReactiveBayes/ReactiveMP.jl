...
@rule GCV(:κ, Marginalisation) (
    q_y_x::Any, q_z::Any, q_ω::Any, meta::GCVMetadata
) = begin
    ...
    psi = @inbounds (y_x_mean[1] - y_x_mean[2])^2 +
                    y_x_var[1, 1] +
                    y_x_var[2, 2] - y_x_var[1, 2] - y_x_var[2, 1]
...
@rule GCV(:κ, Marginalisation) (
    q_y::Any, q_x::Any, q_z::Any, q_ω::Any, meta::GCVMetadata
) = begin
